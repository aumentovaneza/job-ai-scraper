 ...
 *   - throws AnthropicException on non-recoverable failures (e.g. invalid key).
 *
 * Construct via AnthropicClientFactory so the key is pulled and decrypted once.
...
class AnthropicClient
{
    ...
    /**
     * Send a Messages API request on behalf of this client's user.
     *
    ...
    public function messages(
        ...
        if (! $response->successful()) {
            ...
            throw new AnthropicException($message, status: $response->status());
        }
        ...
        return new AnthropicResponse(
            text: AnthropicResponse::textFrom($raw),
